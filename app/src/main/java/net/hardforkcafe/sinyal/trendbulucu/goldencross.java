...
public class goldencross extends AppCompatActivity {
    SwipeRefreshLayout mySwipeRefreshLayoutG;


    private CustomWebViewClient webViewClient;
    private String Url = "http://uygulama.hardforkcafe.net/goldencross.html";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goldencross);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        mySwipeRefreshLayoutG = (SwipeRefreshLayout)this.findViewById(R.id.swiperefreshG);
        ...
        final WebView webView = (WebView) findViewById(R.id.goldencross);//webview mızı xml anasayfa.xml deki webview bağlıyoruz
        ...
        mySwipeRefreshLayoutG.setOnRefreshListener(
...
//                Intent intent = new Intent(goldencross.this,MainActivity.class);
